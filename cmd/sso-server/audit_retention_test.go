...
func TestRunAuditRetention_PrunesOldEventsAtInterval(t *testing.T) {
	...
	go runAuditRetention(runCtx, done, sink, 50*time.Millisecond, 1*time.Second, quietLogger())
...
func TestRunAuditRetention_ExitsOnCtxCancelBeforeFirstTick(t *testing.T) {
	...
	go runAuditRetention(runCtx, done, sink, 1*time.Hour, 30*24*time.Hour, quietLogger())
...
func TestRunAuditRetention_PruneErrorDoesNotStopLoop(t *testing.T) {
	...
	go runAuditRetention(runCtx, done, sink, 30*time.Millisecond, 30*24*time.Hour, quietLogger())
