...
// handleRegister (RFC 7591 DCR, rate-limit-gated) moved to server_signup.go — see
...
// === Authorization policy bundle handler (migrated from authz_policy_bundle.go) ===
...
// that file under the maintainability budget; called from mountAdminSurface.
