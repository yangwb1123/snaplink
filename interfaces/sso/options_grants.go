...
//
// This and WithIntrospectionSigner set the SAME field — this one is for
// deployments that want a fully isolated key; WithIntrospectionSigner is
// for reusing an existing signing issuer. If BOTH are wired, whichever
// Option runs last wins (cmd wires this one after WithIntrospectionSigner
// — see wireIntrospectionSigning).
//
