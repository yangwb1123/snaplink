...
// Server field accessors — thin getters exposing internals to hexagonally-
// extracted handlers (internal/, oauth/, oidc/, selfservice/).
...
func (s *Server) StreamStore() caep.StreamStore         { return s.caepStreamStore }
...
func (s *Server) DeviceStore() device.Store              { return s.deviceStore }
func (s *Server) LoginHistoryStore() device.HistoryStore { return s.loginHistory }
...
func (s *Server) TenantStore() tenant.Store                 { return s.tenantStore }
