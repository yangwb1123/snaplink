...
// [core.JWKSProvider] so the matching public key surfaces at
...
var _ core.JWKSProvider = (*ECDHJWEDecrypter)(nil)
...
// JWKS satisfies [core.JWKSProvider] so the public encryption key surfaces
// at /.well-known/jwks.json (use:"enc") alongside the issuer's signing
// keys.
func (d *ECDHJWEDecrypter) JWKS(_ context.Context) ([]core.JWK, error) {
	return []core.JWK{d.pubJWK}, nil
}
