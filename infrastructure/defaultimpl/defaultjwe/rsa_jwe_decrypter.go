...
// AND [core.JWKSProvider] so the matching public key surfaces at
...
// and wire it via sso.WithJARDecrypter (server option).
...
// JWKS satisfies [core.JWKSProvider] so the public encryption key
...
func (d *RSAJWEDecrypter) JWKS(_ context.Context) ([]core.JWK, error) {
