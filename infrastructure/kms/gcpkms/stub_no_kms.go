...
// Package gcpkms is stubbed out when compiled with -tags no_kms_gcpkms.
package gcpkms
...
var ErrExcluded = errors.New("gcpkms: excluded by build tag no_kms_gcpkms — rebuild without -tags no_kms_gcpkms to use GCP KMS")
