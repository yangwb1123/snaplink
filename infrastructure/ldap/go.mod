// Separate nested module so the LDAP stack (github.com/go-ldap/ldap/v3 +
// its asn1-ber transitive dep) NEVER enters the core sso module's go.mod
// (the firm zero-external-SDK invariant). Operators opt into LDAP / Active
