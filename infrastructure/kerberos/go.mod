// Separate nested module so the Kerberos/SPNEGO stack
// (github.com/jcmturner/gokrb5/v8 and its asn1/crypto transitive deps)
// NEVER enters the core sso module's go.mod (the firm zero-external-SDK
