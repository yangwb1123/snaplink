...
var cycloExemptions = map[string]int{
	...
	"examples/basic/main.go:buildAuthenticators":                         18,
	"mesh_authz.go:(*Server).MeshAuthorize":                              19,
	"migrate/migrate.go:Run":                                             17,
...
var funcLenExemptions = map[string]int{
	...
	"cmd/sso-import/parsers.go:parseCSV":                                 55,
	"cmd/sso-import/parsers.go:parseKeycloak":                            60,
	"cmd/sso-server/build_stores.go:buildApp":                            77,
	"cmd/sso-server/main.go:main":                                        84,
	"cmd/sso-snapshotctl/main.go:runVerify":                              80,
