// Separate nested module so the RADIUS stack (layeh.com/radius, the standard
// pure-Go RADIUS library) NEVER enters the core sso module's go.mod (the firm
// zero-external-SDK invariant). Operators opt into RADIUS / NPS-backed identity
// (this server acting as a RADIUS CLIENT against an enterprise RADIUS server)
